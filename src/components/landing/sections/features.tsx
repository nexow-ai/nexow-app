...
const features = [
  {
    ...
    description:
      "Describe your strategy in plain English. Our AI converts it into a precise, executable trading bot or agent.",
  ...
  },
  {
    ...
    description:
      "Rule-based bots for speed and backtesting. Agents with LLM reasoning, news analysis, sentiment scoring, and web search.",
