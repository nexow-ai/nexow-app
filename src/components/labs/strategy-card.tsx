...
function ProgressRing({
  ...
  const color = value >= 80 ? "#34d399" : value >= 50 ? "#fbbf24" : "#52525b";
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-500">
                {strategy.type === "bot" ? "Rule-Based Bot" : "AI Agent"}
              </p>
            </div>
          </div>
          ...
          {strategy.entryRules && (
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <span className="text-zinc-200">{strategy.entryRules}</span>
              </div>
            </div>
          )}
                ...
                {strategy.exitConfig.stop_loss_pct && (
                  <span className="flex items-center gap-1">
                    ...
                    <span className="text-red-400/80">
                      SL {strategy.exitConfig.stop_loss_pct}%
                    </span>
                  </span>
                )}
                {strategy.exitConfig.take_profit_pct && (
                  <span className="flex items-center gap-1">
                    ...
                    <span className="text-emerald-400/80">
                      TP {strategy.exitConfig.take_profit_pct}%
                    </span>
                  </span>
                )}
              </div>
