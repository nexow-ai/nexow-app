...
export function AgentCard({ agent, linkPrefix, performance }: AgentCardProps) {
  const prefix = linkPrefix ?? (agent.type === "bot" ? "/bots" : "/agents");

  return (
    <Link href={`${prefix}/${agent.id}`}>
